...
Porcupine is an autogenerated, ergonomic, split, 44 key, wired/wireless, columnar-staggered keyboard. It is designed to fit my needs and my hand, but it can be easily updated thanks to declarative design.
...
* Only one variant in v2:
  * regular 6x3 column-staggered ortholiner layout with 4 thumb keys (44 keys total)
* Wired or wireless
* Scroll-wheels on both sides
* [nice!view](https://nicekeyboards.com/nice-view) OLED display
...
* 44 Choc V1 Low profile switches
* 44 Kailh Choc hot-swap sockets
* 46 diodes (SMD or THT) (additional 2 for scroll wheel)
* 44 keycaps
